...
@Controller
public class ShowChecklistController {
...
/*
	...
	public String checklistpage(@ModelAttribute("checklist") Checklist checklist,@ModelAttribute("insurance")Insurance insurance,BindingResult result, Model model, HttpServletRequest request, final RedirectAttributes redirectAttributes) {
			...
			procedure.setChecklist_id(checkid);
